({define:typeof define!='undefined'?define:function(deps, factory){module.exports = factory();}}).define([], function(){
  var exports = function(__obj) {
    ...
    (function() {
      (function() {
        var k, v, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
        ...
        _ref11 = ((_ref9 = this.menu.childs) != null ? (_ref10 = _ref9.references) != null ? _ref10.childs : void 0 : void 0) || {};
        for (k in _ref11) {
          v = _ref11[k];
          __out.push('\n      <li class="window-article-menu__list">\n        <a href="/references/');
          __out.push(__sanitize(v._id));
          __out.push('/');
          if (((_ref12 = this.query) != null ? _ref12.next : void 0) != null) {
            __out.push(__sanitize("?next=" + this.query.next));
          }
          __out.push('" class="window-article-menu__link ');
          if (((_ref13 = this.article) != null ? _ref13._id : void 0) === v._id) {
            __out.push('window-article-menu__link_active');
          }
          __out.push('"> <!--  -->\n          ');
          __out.push(__sanitize(v.title));
        ...
        __out.push((_ref14 = this.article) != null ? _ref14.text : void 0);
